...
console.log(
  " 2 - A quantidade de pessoas pessoas do sexo Feminino é: " + quantidadeF
);
...
console.log(
  " 3 - A soma do salário de todas as pessoas é: R$ " + totalSalario.toFixed(2)
);
...
console.log(" 7 - Existe algum salário superior a R$ 7.000 ? " + maiorQue7000);
...
function nomesDoArray(data) {
  return data.map((element) => element.nome);
}

const nomesSeparados = nomesDoArray(data).map((nome) => nome.split(" "));
